# Source : https://medium.com/@sujit.kumar731/conversion-of-keras-model-to-tensorrt-model-443c92801622

import tensorflow as tf
import tensorflow.compat.v1.keras.backend as K # au lieu de tensorflow.keras.backend pour tensorflow < 2
...
input_model = "fire_testfull_model.h5"
output_pb_model = "./frozen_model.pb"

keras_to_frozen_pb(input_model, output_pb_model)